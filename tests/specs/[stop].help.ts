...
describe('help', () => {
   describe('show help', () => {
      ...
      test('parameters with optional --', () => {
         ...
         expect(mocked.processExit.calls).toStrictEqual([[0]])
         expect(mocked.consoleLog.calls).toStrictEqual([['my-cli\n\n\u001B[1mUsage:\u001B[22m\n  my-cli [luminars...] <arg-a> [arg-b] [--] [arg-c]\n\n\u001B[1mLuminars:\u001B[22m\n  -h, --help        Show help\n']])
      })
      ...
      cli({
         ...
         help: {
            ...
            render(nodes, renderers) {
               ...
               // Replace "luminars" with "options" in Usage
               nodes[0].data.body = nodes[0].data.body.replace('luminars', 'options')
               ...
               // Split Luminars into "Simple options" and "Advanced options"
               const luminars = nodes[2].data.body.data
               nodes.splice(2, 1, {
                  type: 'section',
                  data: {
                     ...
                     body: {
                        ...
                        data: {
                           ...luminars,
                           tableData: luminars.tableData.filter(
                              ([luminarName]: [{ data: { name: string } }]) => (
                                 luminarName.data.name in simpleLuminars
                              ),
                           ),
                        },
                     },
                  ...
                  data: {
                     ...
                     body: {
                        ...
                        data: {
                           ...
                           tableData: luminars.tableData.filter(
                              ([luminarName]: [{ data: { name: string } }]) => (
                                 luminarName.data.name in advancedLuminars
                              ),
                           ),
                        },
                     },
               ...
               // Update renderer so luminars that accept a value shows `=...`
               renderers.luminarOperator = () => '='
               renderers.luminarParameter = luminarType => (luminarType === Boolean ? '' : '...')
