import type { TypeLuminarOptions } from 'luminar'
import type {
   CallbackFunction,
   HelpOptions,
   Luminars,
...
export interface CommandOptions<Parameters = string[]> {
   /**
   ...
   */
   ...
   /**
   Luminars accepted by the command
   */
   luminars?: Luminars
...
export function command<
   Options extends CommandOptions<[...Parameters]>, Parameters extends string[],
>(
...
export interface Command<
   Options extends CommandOptions = CommandOptions, ParsedType = any,
> {
