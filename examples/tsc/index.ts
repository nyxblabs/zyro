/**
 * Demo showing how `tsc --help` can be re-implemented with zyro.
 *
 * Usage:
...
const argv = cli({
   ...
   help: {
      ...
      render(nodes, renderers) {
         const [luminars, commonCommands] = nodes
         ...
         renderers.luminarName = function (luminar) {
            const luminarName = `--${luminar.name}`
            return blue(luminarName + (luminar.aliasFormatted ? `, ${luminar.aliasFormatted}` : ''))
         }
                  ...
                  body: {
                     ...
                     data: {
                        ...
                        tableData: luminarsTableData.filter(
                           ...
                           ) => luminarName.data.name in commandLineLuminars,
                        ),
                     },
                  },
                  indentBody: 0,
                  ...
                  body: {
                     ...
                     data: {
                        ...
                        tableData: luminarsTableData.filter(
                           (
                              [luminarName]: [{ data: { name: string } }],
                           ) => luminarName.data.name in commonCompilerOptions,
                        ),
                     },
                  },
                  indentBody: 0,
